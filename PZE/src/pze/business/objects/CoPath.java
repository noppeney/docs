...
public class CoPath extends AbstractCacheObject {
	...
	public String getDokumentPath() throws Exception {
		...
		if (getRowCount() != 1)
		{
			MessageBox.show("Fehler", "Der Dokumentenpfad ist nicht eindeutig.<br>Es sind " + getRowCount() + " Pfade angegeben.<br>" +
					"Dies kann ggf. zu weiteren Fehlern führen.", "msgbox.stop");
		}
	...
	public void open(String filename) throws Exception
	{
		...
		{
			MessageBox.show("Fehler beim Öffnen der Datei", "Die ausgewählte Datei konnte nicht geöffnet werden.<br>" +
